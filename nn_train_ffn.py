...
def main():
    ...
    logger.info(f"✓ Autoencoder saved to {Config.AUTOENCODER_PATH}")
    logger.info(f"  Default threshold: {recon_threshold_95:.6f} (95th percentile)")
    logger.info("="*60)
    
    logger.info("\n" + "="*60)
    logger.info("TRAINING COMPLETE!")
    logger.info("="*60)
    logger.info("All models and parameters saved:")
    logger.info(f"  ✓ {Config.MODEL_PATH_FFN} - FFN classifier")
    logger.info(f"  ✓ {Config.AUTOENCODER_PATH} - Class-conditional autoencoder")
